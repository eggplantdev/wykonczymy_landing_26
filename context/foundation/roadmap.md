...
**Status:** done · **Change ID:** `f2-i18n-spine` · **Depends on:** F1
...
- **F2: Localization spine + localized `slug`** — Archived 2026-09-03 → `context/archive/2026-09-03-f2-i18n-spine/`. Lesson: —.
