...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_pages_page_type" AS ENUM('home', 'offer', 'completed-works', 'interior-styles', 'contact', 'price-list');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_page_type" AS ENUM('home', 'offer', 'completed-works', 'interior-styles', 'contact', 'price-list');
