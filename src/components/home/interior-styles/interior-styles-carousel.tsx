    ...
    <section className={cn(container, carousel.className)}>
      ...
      >
        ...
        {/* `container-end` renders after the track but still inside Swiper's context, which
            ...
            something the visitor cannot see the edges of. The section drops its right padding to
            let the track run off the screen, so the row puts it back. */}
        <div
          slot="container-end"
          className="grid grid-cols-3 items-center pt-4 pr-6 md:pr-8 xl:pr-12"
        >
          <ButtonLink
            label={t('more')}
            href={ctaHref}
