...
type PropsT = {
  ...
  // `xl` is the size a tappable pill wants; the header's copy is a small marker beside the
  // nav rather than a target, so it asks for `sm`.
  size?: ButtonSizeT
  onClick?: () => void
  className?: string
}
  ...
  return (
    ...
    >
      ...
      <FontAwesomeIcon
        icon={faPhoneVolume}
        className={cn(
          'origin-top motion-safe:animate-ring',
