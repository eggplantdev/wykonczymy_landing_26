...
// The parts of the home group that do not translate: which page each button opens, and
// the figures on the numbers cards. Their row order is what pairs them with the copy.
